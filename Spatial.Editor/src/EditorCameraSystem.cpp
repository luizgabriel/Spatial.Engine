...
void EditorCameraSystem::onStart()
{
...
float3 EditorCameraSystem::getInputAxis()
{
	return {
...
void EditorCameraSystem::onUpdateFrame(float delta)
{
...
EditorCameraSystem::EditorCameraSystem(Stage& stage, desktop::Window& window, const desktop::InputState& inputState)
