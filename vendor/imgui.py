...
target_compile_definitions(${PROJECT_NAME} PUBLIC "ImTextureID=${IMGUI_TEXTURE_ID}")
...
class IMGUIConan(ConanFile):
    ...
    def source(self):
        ...
        tools.replace_in_file("source_subfolder/imgui.cpp", "(void*)(intptr_t)pcmd->TextureId",
                              '(void*)(intptr_t)pcmd->TextureId.get()')
        tools.replace_in_file("source_subfolder/imgui_widgets.cpp", "(void*)(intptr_t)user_texture_id",
                              '(void*)(intptr_t)user_texture_id.get()')

    def _configure_cmake(self):
        cmake = CMake(self)
        cmake.definitions["IMGUI_TEXTURE_ID"] = "std::shared_ptr<void>"
        cmake.definitions["IMGUI_USER_CONFIG"] = "<memory>"
        cmake.configure()
        return cmake
